...
export const roots: RootDef[] = [
  {
    ...
    children: [
      ...
      { id: 'g-hiphop', label: 'Hip-Hop', query: { free_text: 'hip-hop rap beats' }, children: [
        { id: 'g-trap', label: 'Trap', query: { vibes: ['trap'], free_text: 'trap 808 hi-hats' } },
        { id: 'g-lofi', label: 'Lo-fi', query: { vibes: ['lo-fi'], free_text: 'lofi chill study beats' } },
        { id: 'g-boombap', label: 'Boom Bap', query: { vibes: ['boom bap'], free_text: 'classic hip-hop sample chops' } },
      ]},
      { id: 'g-rock', label: 'Rock', query: { free_text: 'rock guitar drums bass' }, children: [
        { id: 'g-altrock', label: 'Alt Rock', query: { vibes: ['alternative rock'], free_text: 'alternative rock guitar distortion' } },
        { id: 'g-classicrock', label: 'Classic Rock', query: { vibes: ['classic rock'], free_text: 'classic rock riff driven blues' } },
        { id: 'g-punk', label: 'Punk', query: { vibes: ['punk'], free_text: 'punk fast aggressive raw guitar' } },
      ]},
      { id: 'g-metal', label: 'Metal', query: { free_text: 'metal heavy distorted guitar' }, children: [
        { id: 'g-heavymetal', label: 'Heavy Metal', query: { vibes: ['heavy metal'], free_text: 'heavy metal power chords riffs' } },
        { id: 'g-thrash', label: 'Thrash', query: { vibes: ['thrash metal'], free_text: 'thrash metal fast aggressive shredding' } },
        { id: 'g-deathmetal', label: 'Death Metal', query: { vibes: ['death metal'], free_text: 'death metal blast beats brutal' } },
      ]},
      { id: 'g-indie', label: 'Indie', query: { free_text: 'indie alternative' }, children: [
        { id: 'g-indierock', label: 'Indie Rock', query: { vibes: ['indie rock'], free_text: 'guitar driven indie band' } },
        { id: 'g-folk', label: 'Folk', query: { vibes: ['folk'], free_text: 'acoustic folk storytelling' } },
      ]},
      { id: 'g-jazz', label: 'Jazz', query: { free_text: 'jazz improvisation swing' }, children: [
        { id: 'g-bebop', label: 'Bebop', query: { vibes: ['bebop'], free_text: 'complex chord jazz fast' } },
        { id: 'g-neosoul', label: 'Neo Soul', query: { vibes: ['neo soul'], free_text: 'soulful groove R&B jazz' } },
        { id: 'g-orchestral', label: 'Orchestral', query: { vibes: ['orchestral'], free_text: 'full orchestra strings brass' } },
      ]},
      { id: 'g-pop', label: 'Pop', query: { free_text: 'pop melodic catchy' }, children: [
        { id: 'g-dreampop', label: 'Dream Pop', query: { vibes: ['dream pop'], free_text: 'reverb ethereal shimmering pop' } },
        { id: 'g-rnb', label: 'R&B', query: { vibes: ['r&b'], free_text: 'rhythm and blues smooth soul' } },
        { id: 'g-neoclassical', label: 'Neoclassical', query: { vibes: ['neoclassical'], free_text: 'sparse piano minimalist' } },
      ]},
    ],
  },
  {
